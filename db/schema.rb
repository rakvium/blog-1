...
ActiveRecord::Schema[7.0].define(version: 20_220_803_070_204) do
  ...
  create_table 'dislikes', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[dislikeable_id dislikeable_type], name: 'index_dislikes_on_dislikeable_id_and_dislikeable_type'
